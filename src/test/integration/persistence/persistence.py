...
def testCats(test_parameters):
    ...
    api.addCat(test_parameters, '{"name":"Jack","groupId":2,"birthDate":"2015-08-18T13:38:21-08:00"}')
    api.addCat(test_parameters, '{"name":"Frank","groupId":1,"birthDate":"2015-08-18T13:37:31-08:00"}')
    api.addCat(test_parameters, '{"name":"Sussie","groupId":2,"birthDate":"2015-08-18T21:37:00-08:00"}')
